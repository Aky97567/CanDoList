...
import { LocalFireDepartment, ExpandMore, ExpandLess, Timer } from "@mui/icons-material";
        ...
        {expanded && (
          <Box sx={{ mt: 1, pl: 3 }}>
            ...
            {habit.lastCompletedDate && (
              <Typography variant="body2">
                Last completed: <strong>{new Date(habit.lastCompletedDate).toLocaleDateString()}</strong>
              </Typography>
            )}
            {atRisk && (
